...
function BannerHeader() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      nextSlide();
    }, 3000); // Sesuaikan durasi jika diperlukan

    return () => clearInterval(interval);
  }, [currentIndex]);

  return (
    <div className="hero-content flex-col lg:flex-row p-0 mt-5 mb-14">
      ...
      <div className="flex-1 max-w-[1400px] h-[600px] w-full m-auto py-16 px-4 relative group ">
